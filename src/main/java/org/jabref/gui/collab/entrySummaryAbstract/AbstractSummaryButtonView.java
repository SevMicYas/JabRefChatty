...
public final class AbstractSummaryButtonView extends DatabaseChangeDetailsView {
    public AbstractSummaryButtonView(AbstractSummaryButton abstractSummaryButton, BibDatabaseContext bibDatabaseContext, DialogService dialogService, StateManager stateManager, ThemeManager themeManager, PreferencesService preferencesService) {
