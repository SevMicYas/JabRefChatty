...
public enum StandardActions implements Action {
    ...
    SET_API_KEY(Localization.lang("Set API key"), IconTheme.JabRefIcons.CHATTY),
    ...
    OPEN_CHATTY("Chatty", Localization.lang("Opens ChatGPT Window"), IconTheme.JabRefIcons.CHATTY),
